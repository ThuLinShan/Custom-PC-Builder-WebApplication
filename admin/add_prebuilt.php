    ...
    <div class="bg-dark row h-25 text-center d-flex flex-column justify-content-center py-5 mx-0">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb d-flex justify-content-center">
                ...
                <li class="breadcrumb-item"><a href="./manage_prebuilt.php" class="text-secondary">Manage Pre-built Desktop</a></li>
    ...
    <?php if (isset($_GET['config']) && $_GET['config'] != "" && ($_GET['config'] == 'intel' || $_GET['config'] == 'amd')) : ?>
        ...
        <div class="container my-5" style="font-family:Verdana, Geneva, Tahoma, sans-serif;">
            ...
            <form method="post" action="./add_prebuilt_logic.php" class="form-control border-0 mt-3 pb-5">
                ...
                <input type="number" class="form-control mb-3 " name="stock" placeholder="Stock" required>
