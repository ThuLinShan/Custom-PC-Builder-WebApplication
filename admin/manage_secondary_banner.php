...
// Fetch banners
$query = "SELECT * FROM banners WHERE type = 'secondary' ORDER BY date";
...
<main>
    <div class="bg-dark text-center d-flex flex-column justify-content-center" style="height: 25vh;">
        <h3 class="text-secondary fw-bold fs-1">Manage Secondary Banners</h3>
        <div>
    ...
    <div class="container py-5">
        <div class="row p-4 rounded shadow-sm">
            <div class="">
                <h3>Please Use banner images with specific aspect ratios</h3>
            </div>
        </div>
