...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 07, 2024 at 08:16 AM
...
(4, 7, 'Intel&reg; Core&trade; i9 processor 14900K', '1703005007core-i9.jpg', 'A popular chip with great performance. Price over performance I guess', 9, ' 5.6', 24, 32, 127, 500, 'https://ark.intel.com/content/www/us/en/ark/products/236773/intel-core-i9-processor-14900k-36m-cache-up-to-6-00-ghz.html'),
...
--
-- Table structure for table `home_brand_banner`
--

CREATE TABLE `home_brand_banner` (
  `id` int(11) NOT NULL,
  `img` varchar(255) NOT NULL,
  `link` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Table structure for table `home_collection_banner`
--

CREATE TABLE `home_collection_banner` (
  `id` int(11) NOT NULL,
  `img` varchar(255) NOT NULL,
  `link` varchar(255) NOT NULL,
...
--
-- Table structure for table `home_popular_product_banner`
--

CREATE TABLE `home_popular_product_banner` (
  `id` int(11) NOT NULL,
...
(1, '4', 'ROG LOKI SFX-L 1000W Platinum', '1702895190ROG-Loki-SFX-L-1000W-Platinum.png', '4.9 x 4.9 x 2.5 inches', 127, 'Yes', 4, 0, 500, 'https://rog.asus.com/power-supply-units/rog-loki/rog-loki-1000p-sfx-l-gaming-model/');
...
--
-- Table structure for table `prebuilt_banner`
--

CREATE TABLE `prebuilt_banner` (
  `id` int(11) NOT NULL,
  `heading` varchar(150) NOT NULL,
  `body` varchar(255) NOT NULL,
  `img` varchar(255) NOT NULL,
...
--
-- Indexes for table `home_brand_banner`
--
ALTER TABLE `home_brand_banner`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `home_collection_banner`
--
ALTER TABLE `home_collection_banner`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `home_popular_product_banner`
--
ALTER TABLE `home_popular_product_banner`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `prebuilt_banner`
--
ALTER TABLE `prebuilt_banner`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `home_brand_banner`
--
ALTER TABLE `home_brand_banner`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `home_collection_banner`
--
ALTER TABLE `home_collection_banner`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `home_popular_product_banner`
--
ALTER TABLE `home_popular_product_banner`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `prebuilt_banner`
--
ALTER TABLE `prebuilt_banner`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
